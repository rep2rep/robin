...
sig
    ...
    type qgenerator = (string -> Property.pValue list) * Property.pKind * Importance.importance;
    type rsgenerator = (string -> Property.pValue list) * Property.pKind;
        ...
        let
            ...
            val (valparser, keypre, defaultImportance) =
                case (findQGenerator key) of
                    SOME kt => kt
                  | NONE => ((fn s => [Property.Label s]),Property.pKindOfString (key ), Importance.Low);
