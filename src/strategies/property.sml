...
sig
    ...
    val fromKVPair : pKind * pValue -> property;
...
fun fromString s =
  ...
  in if vs = "" then fromKVPair (pKindOfString s, Boolean true)
     else fromKVPair (pKindOfString ks, Label vs)
  end;
